<template>
    <div class="vista vista-fill">
        <div class="head">
            <strong v-if="vista.formato_id == null">Formatos BPM</strong>
...
export default {
    ...
    created() {
        this.vista = this.useVistas.vFormatosBpm
    ...
    methods: {
        ...
        async loadOneFormatoValue(item) {
            ...
            const send = {
                ...
                cuarentena_producto: res1.data.cuarentena_producto,
        ...
        async eliminarFormatoValue(item) {
            ...
            this.useVistas.removeItem('vFormatosBpm', 'formato_values', item)
        },
