        ...
        <div class="head">
            ...
            <div class="buttons">
                <JdButton text="Nuevo" title="Crear nuevo" @click="nuevo()"
                    v-if="useAuth.verifyPermiso('vArticuloCategorias_crear')" />
            </div>
        </div>
...
export default {
    ...
    data: () => ({
        ...
        tableRowOptions: [
            { id: 1, label: 'Editar', icon: 'fa-solid fa-pen-to-square', action: 'editar', permiso: 'vArticuloCategorias_editar' },
            { id: 2, label: 'Eliminar', icon: 'fa-solid fa-trash-can', action: 'eliminar', permiso: 'vArticuloCategorias_eliminar' },
        ],
    }),
    created() {
