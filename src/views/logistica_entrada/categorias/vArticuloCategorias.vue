...
export default {
    ...
    data: () => ({
        ...
        tableRowOptions: [
            ...
            { label: 'Editar', icon: 'fa-solid fa-pen-to-square', action: 'editar', permiso: 'vArticuloCategorias_editar' },
            { label: 'Eliminar', icon: 'fa-solid fa-trash-can', action: 'eliminar', permiso: 'vArticuloCategorias_eliminar' },
        ],
    }),
    created() {
