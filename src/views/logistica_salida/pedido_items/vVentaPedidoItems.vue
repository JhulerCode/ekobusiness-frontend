...
export default {
    ...
    methods: {
        ...
        setQuery() {
            this.vista.qry = {
                fltr: { socio_pedido_tipo: { op: 'Es', val: 2 } },
        ...
        async openConfigFiltros() {
            ...
            cols.find((a) => a.id == 'socio_pedido_socio').lista = this.vista.socios
